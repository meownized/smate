...
ActiveRecord::Schema.define(version: 20_200_527_193_739) do
  ...
  create_table 'conversations_users', id: false, force: :cascade do |t|
    ...
    t.index %w[conversation_id user_id], name: 'index_conversations_users_on_conversation_id_and_user_id'
    t.index %w[user_id conversation_id], name: 'index_conversations_users_on_user_id_and_conversation_id'
  end
